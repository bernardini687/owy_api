...
const currentWeatherErrorPayload = require('../../test/payloads/open_weather/current_weather.error')
const currentWeatherSuccessPayload = require('../../test/payloads/open_weather/current_weather.success')
  ...
  describe('when successful', () => {
    beforeAll(() => {
      axiosMock.get.mockImplementation(() =>
        Promise.resolve({
          status: 200, // TODO: double check wrap/unwrapping of successful/unsuccessful responses
